class Day22
  ...
  def initialize(input=nil)
    @reboot_steps =
      (input || real_input)
        .split("\n")
        .map{|line| RebootStep.new(line)}
  end

  # @example small
  #   day = Day22.new(SMALL_INPUT)
  #   day.part1 #=> 39
  # @example input
  #   day.part1 #=> 590784
  # @example part2 but only init area
  #   day = Day22.new(PART2_EXAMPLE)
  #   day.part1 #=> 474140
  def part1
  ...
  def real_input
    File.read('../inputs/day22-input.txt')
  end
