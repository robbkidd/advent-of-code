...
class Grid
  ...
  def offset_to_direction
    @offset_to_direction || raise("You must set_cardinal_neighbors or set_surrounding_neighbors for this Grid.")
  end

  def set_cardinal_neighbors
    @offset_to_direction = {
      # r   c
      [-1, 0] => "^", # up a row
      [1, 0] => "v", # down a row
